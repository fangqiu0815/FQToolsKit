...
@interface FQThreeViewController ()<UITableViewDelegate>

@end

@implementation FQThreeViewController
...
{
    FQOtherViewController *new = [[FQOtherViewController alloc]init];
