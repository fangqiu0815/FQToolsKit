...
@property (nonatomic, strong) FQGCDTimerManage *timerManager;
...
-(void)GCDbtnClick{
    ...
    [[FQGCDTimerManage sharedInstance]cancelTimerWithName:@"mytimers"];
    
    __weak typeof(self) weakSelf = self;
    
    [[FQGCDTimerManage sharedInstance]scheduledDispatchTimerWithName:@"mytimers" timeInterval:1 queue:nil
                                                               repeats:YES actionOption:FQGCDTimerTypeAbandonPreviousAction action:^{
