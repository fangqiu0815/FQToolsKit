...
extern const NSUInteger FQIndexViewInvalidSection;
extern const NSInteger FQIndexViewSearchSection;

typedef NS_ENUM(NSUInteger, FQIndexViewStyle) {
    FQIndexViewStyleDefault = 0,    // 指向点
    FQIndexViewStyleCenterToast,    // 中心提示弹层
};

@interface FQIndexesViewConfig : NSObject

@property (nonatomic, assign, readonly) FQIndexViewStyle indexViewStyle;    // 索引提示风格
