...
- (void)viewDidLoad {
    ...
    //navigation
    [self.navigationController.navigationBar setBackgroundImage:[WHGradientHelper getLinearGradientImage:kColor1 and:kColor2 directionType:WHLinearGradientDirectionHorizontal option:CGSizeMake(375, 64)] forBarMetrics:UIBarMetricsDefault];
    ...
    image000.image = [WHGradientHelper getLinearGradientImage:kColor3 and:kColor4 directionType:WHLinearGradientDirectionHorizontal];
